...
const togleForm = ()=> setFrom(!form)
  ...
  return (
    ...
    <div className='w-full shadow-md relative'>
     ...
     { form&& <div className="left-1/2 -translate-x-1/2 top-28 overflow-y-scroll md:h-140 mb-4   absolute w-100 md:w-150  bg-white p-6  shadow-md rounded-xl side-line">
